      ...
      <div class="col s6 md3">
        <div class="card z-depth-0">
          <div class="card-content center">
            <h6><?php echo htmlspecialchars($meal['userName']); ?></h6>
            <ul>
              <?php foreach (explode(',', $meal['children']) as $special) : ?>
                <li><?php echo htmlspecialchars($special) ?></li>
              <?php endforeach ?>
            </ul>
          </div>
          <div class="card-action right-align">
            <a class="brand-text" href="details.php?id=<?php echo $meal['userId'] ?>">more info</a>
